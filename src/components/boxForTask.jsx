...
<div id="boxTask" className="w-[450px] h-[560px] bg-white m-auto mt-[90px] rounded-[20px]">
    <div className="pt-14">
        ...
        <aside id="inputs" className="mt-20 columns-1 text-center align-middle">
            ...
            <input type="text" className="border-2 w-[290px] pt-[10px] p-[10px] rounded-[8px]" placeholder="Nome da tarefa" /><br />
            
            <input type="text" className="border-2 w-[290px] mt-[15px] pt-[10px] p-[10px] rounded-[8px]" placeholder="Descrição da tarefa (*opcional)" />
        </aside>

        <article id="buttons" className="flex justify-around mt-10">
           <div id="btnAdd">
            <button className="border-2 w-40 p-[10px] rounded-[8px]">adicionar</button>
           </div>
